...
SCRIPT_SUBDIR="optical_only/scripts/analysis"
SCRIPT_REL_PATH="optical_only/scripts/analysis/submit_snana_first_detection_delay.sh"
...
PYTHON_SCRIPT="${SCRIPT_DIR}/snana_first_detection_delay.py"
