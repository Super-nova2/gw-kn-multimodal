...
SCRIPT_SUBDIR="optical_only/scripts/train"
SCRIPT_REL_PATH="optical_only/scripts/train/train.sh"
...
DEFAULT_ARGS_FILE="${OPTICAL_ONLY_DIR}/args/optical_only_kn_baseline.json"
...
EVAL_PY="${OPTICAL_ONLY_DIR}/scripts/eval/evaluate.py"
