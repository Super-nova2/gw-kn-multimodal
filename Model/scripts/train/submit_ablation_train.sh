...
# Usage: bash Model/scripts/train/submit_ablation_train.sh
set -euo pipefail

REPO_ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")/../../.." && pwd)"
TRAIN_SCRIPT="${REPO_ROOT}/Model/scripts/train/train.sh"
DEFAULT_CONFIG="${REPO_ROOT}/Model/args/defaults/MAGIKS_BNS_NSBH_default.json"
