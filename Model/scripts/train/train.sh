...
#SBATCH --job-name=MAGIKS_bns_nsbh
...
SCRIPT_SUBDIR="Model/scripts/train"
SCRIPT_REL_PATH="Model/scripts/train/train.sh"
REPO_NAME="gw-kn-multimodal"
DEFAULT_CONFIG_REL_PATH="Model/args/defaults/MAGIKS_BNS_NSBH_default.json"
