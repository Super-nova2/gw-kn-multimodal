...
#SBATCH --job-name=MAGIKS_model_speed
...
SCRIPT_REL_PATH="Model/scripts/eval/submit_model_speed_benchmark.sh"
PY_REL_PATH="Model/scripts/eval/benchmark_model_speed.py"
