#!/usr/bin/env python3
"""Merge a single-model run into an existing GW170817A retrieval result."""
...
from eval_gw170817a_retrieval import (
...
def merge_results(base_path: Path, supplement_path: Path, output_dir: Path) -> Path:
    ...
    merged["supplement_provenance"] = {
        ...
        "added_method": method,
        "gallery_validation": list(GALLERY_CONFIG_KEYS),
    }
    ...
    plot_redshift_coverage(merged["redshift_rows"], output_dir)
