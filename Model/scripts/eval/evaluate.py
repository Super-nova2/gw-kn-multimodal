"""
Comprehensive evaluation script for GW-KN MAGIKS model.
...
Usage:
    python Model/scripts/eval/evaluate.py \\
...
def parse_args():
    p = argparse.ArgumentParser(description="Evaluate GW-KN MAGIKS model")
    ...
    p.add_argument("--config", type=str, default=None,
                   help="Path to training config JSON (e.g. args/MAGIKS_BNS_NSBH_full.json)")
...
if __name__ == "__main__":
    "python Model/scripts/eval/evaluate.py --checkpoint ${BASE_DIR}/data/model/checkpoints/supcon_v1/ALBEF/albef_best.pth --test_data_path ${BASE_DIR}/data/LSST_KN_BNS/combined_dataset_with_neg_gw.h5 --output_dir eval_results"
    main()
